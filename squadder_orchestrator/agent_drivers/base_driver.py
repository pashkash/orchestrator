...
# type: METHOD
# use_case: Контракт для любого runtime driver-а (mock или OpenHands).
# feature:
#   - universal TaskUnit не должен знать, каким именно runtime исполнен шаг
#   - Task card 2026-03-24_1800__multi-agent-system-design, D4/D5
# pre:
#   - request.prompt не пустой
# post:
#   - возвращает DriverResult с status и payload
# invariant:
#   - driver implementation не должна мутировать request
# modifies (internal):
#   -
# emits (external):
