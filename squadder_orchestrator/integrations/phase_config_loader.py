...
from squadder_orchestrator.graph_compiler.yaml_manifest_parser import (
    FlowManifest,
    RuntimeConfig,
    load_flow_manifest,
    load_runtime_config,
...
# type: METHOD
# use_case: Загружает metadata доменной или supervisor/collector роли из docs role.yaml.
# feature:
#   - runtime config использует docs/common/roles как knowledge source
#   - Task card 2026-03-24_1800__multi-agent-system-design, D1
# pre:
#   - role.yaml существует в docs/common/roles/{role_dir}/role.yaml
# post:
#   - возвращает типизированный RoleMetadata
# invariant:
#   - role.yaml читается только в readonly режиме
# modifies (internal):
