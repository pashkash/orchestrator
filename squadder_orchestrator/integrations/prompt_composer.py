...
from squadder_orchestrator.integrations.phase_config_loader import resolve_runtime_path
...
# type: METHOD
# use_case: Собирает runtime prompt для одного шага TaskUnit.
# feature:
#   - Использует docs/common/roles markdown как knowledge base
#   - Дописывает phase-specific output contract для устойчивого парсинга driver layer
# pre:
#   - prompt file из step_config существует
# post:
#   - возвращает итоговый system/user prompt bundle как plain text
# invariant:
#   - markdown файлы не мутируются
# modifies (internal):
