...
# type: METHOD
# use_case: Применяет простой набор V1 guardrails к результату шага TaskUnit.
# feature:
#   - V1 guardrails проверяют только обязательные поля, чекбоксы и базовую форму StructuredOutput
#   - Task card 2026-03-24_1800__multi-agent-system-design, D0/D4
# pre:
#   - payload — dict от driver step
#   - step_name один из executor/reviewer/tester
# post:
#   - возвращает GuardrailResult с PASS или NEEDS_FIX_* status
# invariant:
#   - payload и task_context не мутируются
# modifies (internal):
#   -
# emits (external):
#   -
